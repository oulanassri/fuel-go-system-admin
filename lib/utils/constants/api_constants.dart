...
class _EndPoints {
  ...
  final String getAdminsByCneter =
      "/api/SystemAdmin/get-admins-by-cneter"; //True
  final String getConstantValues =
      "/api/ConstantDictionary/get-constant-values"; //GET True
  //City
  final String getCities = "/api/City/get-cities"; //GET True

  //Neighborhood
  final String getNeighborhood =
      "/api/Neighborhood/get-neighborhood"; //GET True

  final String editConstantValue =
      "/api/ConstantDictionary/edit-constant-value"; //GET True
